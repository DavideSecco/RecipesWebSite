...
class RicettaDetailViewTests(TestCase):
    def test_funzioni_per_persone_loggate_non_sono_attive_quando_utente_non_e_loggato(self):
        r1 = Ricetta.objects.create(nome='ricetta 1')
    ...
    def test_funzioni_per_persone_loggate_sono_attive_quando_utente_e_loggato(self):
